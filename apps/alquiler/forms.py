...
class CrearAlquilerForm(forms.ModelForm):
    ...
    class Meta:
        model = Alquiler
        fields = ['Direccion_Propiedad','Dueno','Inquilino','Fecha_contrato','Precio_mensual','Meses_actualizacion_IPC','Porcentaje_actualizacion','Precio_Agua','Precio_ABL','Observacion' ]
